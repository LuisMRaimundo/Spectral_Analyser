...
| [docs/DENSITY_EXPORT_SCHEMA.md](DENSITY_EXPORT_SCHEMA.md) | **Authoritative** workbook layout: `Density_Metrics`, `Canonical_Metrics`, `Diagnostic_Metrics`, `Debug_Counts`, PCA/dissonance separation, redaction. |
