...
| P1 | G3 contradiction | `tools/p1_g3_swap.py` | Dated live swap on `aa24de8`. 3 % tolerance FAIL. WP1 live acceptance withdrawn. P5/P6 stopped. | **FAIL (this PR)** |
| P2 | CI green on tagged code | `.github/workflows/ci.yml` | Full suite 3.10/3.11; live G3 tests skip when audio is absent. | **pending this PR** |
| P3 | Post-rating doc fixes | `REFERENCES.md`, this page, `TROMBONE_AS2_DEFECT_FIX_DIFF.md` | Sethares 2005; WP6 cell; A♯2 residual columns (post-fix only). | **done (this PR)** |
